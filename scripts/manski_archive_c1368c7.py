# VERBATIM copy of crl/manski.py from branch manski-port-archive (c1368c7).
# DO NOT EDIT: imported by scripts/m0_agreement_equivalence.py so that M0
# exercises the real archived Thm-2 sampler without switching branches.
